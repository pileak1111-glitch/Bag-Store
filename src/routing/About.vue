<template>
  <div class="max-w-2xl mx-auto p-4 bg-white shadow-md rounded-lg mt-10">
    <h2 class="text-blue-600 text-2xl font-semibold text-center mb-4">About Us</h2>
    
    <p class="text-gray-700 text-center mb-6 text-sm">
      Welcome to our store! We are dedicated to providing high-quality products with excellent customer service.  
    </p>

    <div class="mt-6 text-sm">
      <h3 class="text-blue-600 text-xl font-semibold mb-2">Our Mission</h3>
      <p class="text-gray-600">
        Our mission is to offer the best products at competitive prices while ensuring a seamless shopping experience for our customers.
      </p>
    </div>
  ...
  <div class=" w-full bg-gray-300 py-4 flex justify-center shadow-lg">
...
export default {
  data() {
    return {
      team: [
        { name: 'ផល ពីល័ក្ខ', description: "Founder & CEO", image: "public/assets/image/phileak.JPG" },
